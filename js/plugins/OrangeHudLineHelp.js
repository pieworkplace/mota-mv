...
var OrangeHudLineHelp = OrangeHudLineHelp || {};

if (Imported["OrangeHudLineHelp"] === undefined) {
  OrangeHudLineHelp.validateParams = function(line) {
  ...
  OrangeHudLineHelp.drawLine = function(window, variableData) {
  ...
  OrangeHudLineHelp.realX = function(variableData) {
  ...
  OrangeHudLineHelp.realY = function(variableData) {
  ...
  OrangeHudLineHelp.getValue = function(variableData) {
    return $gameVariables.value(variableData.VariableId);
  };

  OrangeHudLineHelp.getKey = function(variableData) {
    return variableData.VariableId;
  };

  OrangeHud.registerLineType('OrangeHudLineHelp', OrangeHudLineHelp);
  Imported["OrangeHudLineHelp"] = 1.6;
}